...
from core.ai.scene_change.model.TANet_element import *
from core.ai.scene_change.model.util import upsample
...
class TANet(nn.Module):
    ...
    def __init__(self, encoder_arch, local_kernel_size, stride, padding, groups, drtam, refinement):
        ...
        self.attention_module = get_attentionmodule(local_kernel_size, stride, padding, groups, drtam, refinement,
                                                    channels)
